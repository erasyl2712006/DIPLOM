...
const TeacherMessages: React.FC = () => {
  ...
  const conversationMessages = React.useMemo(() => {
    ...
    return messages
      .filter(msg => 
        (msg.senderId === 't1' && msg.receiverId === selectedConversation) || 
        (msg.senderId === selectedConversation && msg.receiverId === 't1')
      )
  ...
  const selectedStudent = React.useMemo(() => {
    ...
    return students.find(student => student.id === selectedConversation) || null;
  }, [selectedConversation]);
            ...
            <div className="mt-4 space-y-1 max-h-[500px] overflow-y-auto">
              {filteredStudents.map(student => {
                ...
                const unreadCount = messages.filter(
                  msg => msg.senderId === student.id && msg.receiverId === 't1' && !msg.isRead
                ).length;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-default-500 truncate">{group?.name}</p>
                    </div>
                  </div>
                );
              })}
          ...
          {selectedStudent ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-default-500">
                      {getGroupById(selectedStudent.groupId)?.name}
                    </p>
                  </div>
                </div>
                <Dropdown>
            ...
            <div className="h-full flex items-center justify-center">
              <div className="text-center text-default-500">
                ...
                <p className="mt-2">Выберите студента из списка слева, чтобы начать общение</p>
              </div>
            </div>
          )}
        </Card>
